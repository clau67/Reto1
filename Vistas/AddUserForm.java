...
public class AddUserForm extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        cbTipoDocumento.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Cédula de Ciudadania", "Cédula de Extranjeria", "Libreta Militar", "Pasaporte", "Otro", " " }));
        ...
        btnCancelar.setBackground(new java.awt.Color(153, 0, 102));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        System.out.println("nombre" + nombre + " " + apellidos 
                + ", documento: " + tipoDocumento + " " + documento + ", correo: " + email);
